...
## Always start mongodb server first and only then it will be able to connect with mongodbcompass
## command for startting mongodb server: sudo service mongod start
